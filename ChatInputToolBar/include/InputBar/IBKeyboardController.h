 ...
 */
@protocol IBKeyboardControllerDelegate <NSObject>
 ...
 */
- (void)keyboardController:(IBKeyboardController *)keyboardController keyboardDidChangeFrame:(CGRect)keyboardFrame;
 ...
 *  @param keyboardController The keyboard controller that is notifying the delegate.
 */
- (void)keyboardControllerKeyboardDidHide:(IBKeyboardController *)keyboardController;
 ...
 */
@interface IBKeyboardController : NSObject

/**
 *  The object that acts as the delegate of the keyboard controller.
 */
@property (weak, nonatomic) id<IBKeyboardControllerDelegate> delegate;
...
- (instancetype)initWithTextView:(UITextView *)textView
            ...
            panGestureRecognizer:(UIPanGestureRecognizer *)panGestureRecognizer
                        delegate:(id<IBKeyboardControllerDelegate>)delegate;
