...
@interface IBMoreInputItemView ()
{
    IBMoreInputItem    *_ltzMoreInputItem;
    UIButton            *_imagebutton;
    UILabel             *_titleLabel;
}
@end

@implementation IBMoreInputItemView
                        ...
                        title:(NSString *)title
{
    ...
    if (self) {
        IBMoreInputItem *ltzMoreInputItem = [[IBMoreInputItem alloc] initWithImageName:imageName
